(function (namespace) {
    namespace.figures.Pyramid = Utils.extend(namespace.figures.BaseFigure, {
        ...
        rotate: function () {
            var rotationMap = [
                    ...
                    this._rotate180.bind(this),
                    this._rotate270.bind(this)
                ],
                state = this.state;

            this.prevState = this.cloneState(this.state);

            (state.rotationFlag === 3) ? state.rotationFlag = 0 : state.rotationFlag++;
